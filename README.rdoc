...
* Source hosted at GitHub[http://github.com/cavalle/steak]
* Report issues on {GitHub Issues}[http://github.com/cavalle/steak/issues]
* Questions and discussions at the {mailing list}[http://groups.google.com/group/steakrb] and the IRC channel #steakrb on freenode
